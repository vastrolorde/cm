...
INSERT INTO `bank` (`id`, `name`) VALUES
	...
	('BTM', 'ธนาคารแห่งโตเกียว-มิตซูบิชิ จก. กรุงเทพฯ '),
	('CAL', 'ธนาคารคาลิยง'),
	('CIM', 'ธนาคารซีไอเอ็มบีไทย จำกัด (มหาชน)'),
	('CIT', 'ธนาคารซิตี้แบงค์'),
	('DEU', 'ธนาคารดอยซ์แบงก์ '),
	('EXT', 'ธนาคารเพื่อการส่งออกและนำเข้าแห่งประเทศไทย'),
	('GHB', 'ธนาคารอาคารสงเคราะห์ '),
	('GSB', 'ธนาคารออมสิน'),
	('HSB', 'ธนาคารฮ่องกงและเซี่ยงไฮ้ จำกัด'),
	('ICB', 'ธนาคารไอซีบีซี (ไทย) จำกัด (มหาชน)'),
	('JPM', 'ธนาคารเจพี มอร์แกน เชส สาขากรุงเทพฯ'),
	('KBA', 'ธนาคารกสิกรไทย จำกัด (มหาชน)'),
	('KK', 'ธนาคารเกียรตินาคิน จำกัด (มหาชน)'),
	('KTB', 'ธนาคารกรุงไทย จำกัด (มหาชน)'),
	('LHB', 'ธนาคารแลนด์ แอนด์ เฮ้าส์ จำกัด (มหาชน)'),
	('MEG', 'ธนาคารเมกะ สากลพาณิชย์ จำกัด (มหาชน)'),
	('MHC', 'ธนาคารมิซูโฮ คอร์เปอเรท สาขากรุงเทพฯ'),
	('SCB', 'ธนาคารไทยพาณิชย์ จำกัด (มหาชน)'),
	('SCI', 'ธนาคารนครหลวงไทย จำกัด (มหาชน)'),
	('SCN', 'ธนาคารสแตนดาร์ด ชาร์เตอร์ด (ไทย) จำกัด'),
	('SMB', 'ธนาคารซูมิโตโม มิตซุย แบงกิ้ง คอร์ปอเรชั่น'),
	('SME', 'ธนาคารพัฒนาวิสาหกิจขนาดกลางและขนาดย่อมแห่งประเทศไทย'),
	('TBA', 'ธนาคารธนชาต จำกัด (มหาชน)'),
	('TCR', 'ธนาคารไทยเครดิตเพื่อรายย่อย จำกัด (มหาชน)'),
	('TIB', 'ธนาคารอิสลามแห่งประเทศไทย'),
	('TIS', 'ธนาคารทิสโก้ จำกัด (มหาชน)'),
...
-- Dumping data for table cm.dist: ~993 rows (approximately)
DELETE FROM `dist`;
/*!40000 ALTER TABLE `dist` DISABLE KEYS */;
INSERT INTO `dist` (`Dist_ID`, `Dist_CODE`, `Dist_NAME`, `POSTCODE`, `GEO_ID`, `Province_ID`) VALUES
...
CREATE TABLE IF NOT EXISTS `employee_data` (
  ...
  `emp_position_now` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `emp_dept_now` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `employee_data` (`id`, `emp_prefix`, `emp_fname`, `emp_lname`, `emp_nickname`, `emp_nation`, `emp_DOB`, `emp_sex`, `emp_position`, `emp_position_now`, `emp_dept_now`, `emp_type`, `emp_startdate`, `emp_enddate`, `emp_status`, `emp_add1`, `emp_add2`, `emp_SubDist`, `emp_Dist`, `emp_Province`, `emp_Postal`, `emp_tel1`, `emp_tel2`, `emp_email`, `emp_emergency`, `emp_emer_call`, `emp_training`, `emp_cid`, `emp_cid_exp`, `emp_passport`, `emp_passport_exp`, `emp_visa`, `emp_visa_exp`, `emp_wp`, `emp_wp_exp`, `emp_driver_license`, `emp_driver_license_exp`, `emp_bike_license`, `emp_bike_license_exp`, `emp_truck_license`, `emp_truck_license_exp`) VALUES
	...
	('CM-1004', 'นาง', 'นางทัศนีย์', 'มัลลิกาพิพัฒน์', 'ตาล', 'ไทย', '15/11/82', 'Female', NULL, 'Account Recieviable/Cashier', 'Office', 'รายเดือน', '01/06/13', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1005', 'นาย', 'ประพันธ์ ', 'วงษ์อุบล', 'พันธ์', 'ไทย', '01/05/71', 'Male', NULL, 'General Supervisor', 'Factory', 'รายเดือน', '02/04/02', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1007', 'น.ส.', 'กัลฐิกา', 'บุญเปรื่อง', 'ฟาง', 'ไทย', '20/11/85', 'Female', NULL, 'Account Payable/Assistant Mana', 'Office', 'รายเดือน', '05/08/14', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1008', 'นาย', 'นนท์ตการ', 'มัลลิกาพิพัฒน์', 'มิกซ์', 'ไทย', '30/11/76', 'Male', NULL, 'Messenger', 'Office', 'รายเดือน', '01/01/11', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1009', 'นาย', 'เกษม', 'พิมพ์จันทร์', 'เกษม', 'ไทย', '23/07/69', 'Male', NULL, 'Messenger', 'Office', 'รายเดือน', '02/04/02', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1010', 'นาย', 'ธนพล', 'จันมีชัย', 'ทอง', 'ไทย', '05/10/60', 'Male', NULL, 'Scaffold Inspector', 'Factory', 'รายเดือน', '08/07/13', '20/02/16', 'ไล่ออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1011', 'นาย', 'อุทัย', 'ทองเฟื้อง', 'ทัย', 'ไทย', '28/10/81', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '21/07/06', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1013', 'นาย', 'Soe Win Than', '', 'แสน', 'พม่า', '04/02/84', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '26/02/13', '31/10/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1014', 'นาง', 'Zar Ni Tun', '', 'ปู', 'พม่า', '17/08/83', 'Female', NULL, 'worker', 'Factory', 'รายวัน', '26/02/13', '31/10/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1015', 'นาย', 'Aw Lan', '', 'ชาติ', 'พม่า', '30/04/86', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '02/12/13', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1016', 'น.ส.', 'Mi Yin Thein', '', 'นุ้ย', 'พม่า', '06/05/87', 'Female', NULL, 'worker', 'Factory', 'รายวัน', '02/04/02', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1017', 'น.ส.', 'Kyi Kyi Nyan', '', 'สา', 'พม่า', '19/04/95', 'Female', NULL, 'worker', 'Factory', 'รายวัน', '14/03/16', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1019', 'นาย', 'Aung Tin', '', 'อ๋อง', 'พม่า', '00/01/00', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '25/07/14', '16/01/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1020', 'นาย', 'Zin Maung Htun', '', 'ซี', 'พม่า', '00/01/00', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '13/08/14', '16/01/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1021', 'นาย', 'Tun Kyaw', '', 'ทุนโจ', 'พม่า', '29/05/84', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '25/07/14', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1022', 'นาย', 'Hlawn Moe Naing', '', 'นาย', 'พม่า', '00/01/00', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '25/07/14', '16/02/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1023', 'นาย', 'Zaw Moe', '', 'ซอม', 'พม่า', '00/01/00', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '25/07/14', '16/01/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1024', 'นาง', 'พูมะลี', 'สิริปันยา', 'เจ', 'ลาว', '06/11/73', 'Female', NULL, 'worker', 'Factory', 'รายวัน', '01/06/09', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1025', 'นาย', 'นาริน', 'กีม', 'นาริน', 'เขมร', '13/07/78', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '07/10/14', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1026', 'นาย', 'Foe Sae', '', 'โพ', 'พม่า', '00/01/00', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '25/07/14', '16/01/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1027', 'นาย', 'Maung Kyaw', '', 'ม่องโจ', 'พม่า', '12/02/87', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '25/07/14', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1028', 'น.ส.', 'เพ็ญโสม ', 'ใจวงค์', 'แคท', 'ไทย', '31/08/90', 'Female', NULL, 'General Manager', 'Management', 'รายเดือน', '01/07/14', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1029', 'นาย', 'Myat San', '', 'ซ่า', 'พม่า', '00/01/00', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '15/01/15', '17/09/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1030', 'นาย', 'เอ๊าท์', ' เม็ท', 'เอ๊าท์', 'เขมร', '00/01/00', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '05/01/15', '04/04/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1031', 'นาย', 'เล็ท', ' เม็ท', 'เล็ท', 'เขมร', '00/01/00', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '22/01/15', '04/04/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1032', 'นาย', 'มิน', '', 'มิน', 'เขมร', '11/02/75', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '05/01/16', '', 'ทดลองงาน', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1033', 'นาย', 'จักรพันธ์', 'นาคนชม', 'โต้', 'ไทย', '29/01/91', 'Male', NULL, 'Accountant', 'Office', 'รายเดือน', '07/05/15', '01/07/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1034', 'นาย', 'สมพงศ์  ', 'นันทไพบูลย์', 'สมพงศ์', 'ไทย', '11/12/52', 'Male', NULL, 'Consultant', 'Management', 'รายเดือน', '01/04/14', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1035', 'น.ส.', 'ทอง', 'ทองทา', 'ทอง', 'ไทย', '25/01/54', 'Female', NULL, 'Maid', 'Office', 'รายเดือน', '02/04/02', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1036', 'นาย', 'Way Lin Tun', '', '', 'พม่า', '08/11/89', 'Male', NULL, 'worker', 'Factory', 'รายวัน', '24/08/15', '17/09/15', 'ลาออก', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1037', 'นาย', 'อัศวเทพ ', 'เริงสำราญ', 'พฤกษ์', 'ไทย', '12/12/90', 'Male', NULL, 'Sales Project Manager', 'Office', 'รายเดือน', '01/09/15', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CM-1038', 'นาย', 'ทักษ์ดนัย', 'ชวาลารัตน์', 'ทักษ์', 'ไทย', '22/08/92', 'Male', NULL, 'Store Supervisor', 'Office', 'รายเดือน', '16/11/15', '', 'บรรจุแล้ว', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
-- Dumping data for table cm.hr_dept: ~3 rows (approximately)
DELETE FROM `hr_dept`;
/*!40000 ALTER TABLE `hr_dept` DISABLE KEYS */;
INSERT INTO `hr_dept` (`id`, `dept_name`, `dept_mother`, `dept_manager`) VALUES
	('MGT', 'Management', '', 'ธนิตศักดิ์  พัชรดิษฐ์ฐากุล'),
	('FACT', 'Factory', 'Management', 'ประพันธ์  วงษ์อุบล'),
	('OPT', 'Operation', 'Factory', 'ทักษ์ดนัย ชวาลารัตน์'),
	('ADM', 'Administrative', 'Management', 'กัลฐิกา บุญเปรื่อง'),
...
-- Dumping data for table cm.hr_position: ~15 rows (approximately)
...
INSERT INTO `hr_position` (`id`, `position_name`, `dept_id`, `position_manager`, `position_obj`, `job_grade`, `job_group`) VALUES
	...
	('0003', 'Corporate Director', 'Management', 'President', NULL, NULL, NULL),
	('0004', 'Account Recieviable/Cashier', 'Office', 'General Manager', NULL, NULL, NULL),
	('0005', 'General Supervisor', NULL, NULL, NULL, NULL, NULL),
	('0006', 'Account Payable/Assistant Manager', NULL, NULL, NULL, NULL, NULL),
	('0007', 'Messenger', NULL, NULL, NULL, NULL, NULL),
	('0008', 'Scaffold Inspector', NULL, NULL, NULL, NULL, NULL),
	('0009', 'worker', NULL, NULL, NULL, NULL, NULL),
	('0010', 'General Manager', NULL, NULL, NULL, NULL, NULL),
	('0011', 'Accountant', NULL, NULL, NULL, NULL, NULL),
	('0012', 'Consultant', NULL, NULL, NULL, NULL, NULL),
	('0013', 'Maid', NULL, NULL, NULL, NULL, NULL),
	('0014', 'Sales Project Manager', NULL, NULL, NULL, NULL, NULL),
	('0015', 'Store Supervisor', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `product_family` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table cm.product: ~200 rows (approximately)
DELETE FROM `product`;
/*!40000 ALTER TABLE `product` DISABLE KEYS */;
INSERT INTO `product` (`product_id`, `product_name`, `product_type`, `product_unit`, `product_weight`, `product_cost`, `product_1stSalePrice`, `product_2ndSalePrice`, `product_d_RentalPrice`, `product_GuaranteePrice`, `product_Desc`, `product_stock`, `product_safety`, `product_Attr`, `product_family`) VALUES
	('BB-4224', 'คานหัวงอ Ø1-1/4" 2.44 m', 'Assets', NULL, 8, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BC-4207', 'คาน Ø1-1/4" 0.7 m หัว Clamp', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BC-4218', 'คาน Ø1-1/4" 1.83 m หัว Clamp', 'Assets', NULL, 6, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BD-4211', 'คานTrussขนาดเล็ก Ø1-1/4" หัวลิ่ม 1 คู่ 1.17 m', 'Assets', NULL, 7, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BD-4218', 'คานTrussขนาดเล็ก Ø1-1/4" หัวลิ่ม 1 คู่ 1.83 m', 'Assets', NULL, 9, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BD-4224', 'คานTrussขนาดเล็ก Ø1-1/4" หัวลิ่ม 1 คู่ 2.44 m', 'Assets', NULL, 13, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BL-4218', 'คานTrussตัวใหญ่ Ø1-1/4" หัวลิ่ม 2 คู่ 1.83 m', 'Assets', NULL, 15, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BL-4224', 'คานTrussตัวใหญ่ Ø1-1/4" หัวลิ่ม 2 คู่ 2.44 m', 'Assets', NULL, 20, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BM-4205', 'คาน Ø1-1/4" 0.54 m', 'Assets', NULL, 2, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BM-4206', 'คาน Ø1-1/4" 0.65 m', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BM-4209', 'คาน Ø1-1/4" 0.915 m', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BM-4210', 'คาน Ø1-1/4" 1.07 m', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BM-4211', 'คาน Ø1-1/4" 1.17 m', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BM-4212', 'คาน Ø1-1/4" 1.22 m', 'Assets', NULL, 4, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BM-4218', 'คาน Ø1-1/4" 1.83 m', 'Assets', NULL, 6, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('BM-4224', 'คาน Ø1-1/4" 2.44 m', 'Assets', NULL, 8, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Beam'),
	('CB-1202', 'Cross Brace 1219x280x1251', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'CB'),
	('CB-1206', 'Cross Brace 1219x610x1363', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'CB'),
	('CB-1209', 'Cross Brace 1219x914x1524', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'CB'),
	('CB-1212', 'Cross Brace 1219x1219x1724', 'Assets', NULL, 2, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'CB'),
	('CB-1802', 'Cross Brace 1829x280x1850', 'Assets', NULL, 2, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'CB'),
	('CB-1806', 'Cross Brace 1829x610x1928', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'CB'),
	('CB-1809', 'Cross Brace 1829x914x2045', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'CB'),
	('CB-1812', 'Cross Brace 1829x1219x2198', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'CB'),
	('CC-BS', 'Beam Swivel Clamp', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Connection'),
	('CC-F', 'Clamp - Fix Clamp', 'Assets', NULL, 1, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Connection'),
	('CC-HF', 'Heavy Duty Clamp - Fix Clamp', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Connection'),
	('CC-HS', 'Heavy Duty Clamp - Swivel Clamp', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Connection'),
	('CC-PC', 'Plank Clamp', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Connection'),
	('CC-S', 'Clamp - Swivel Clamp', 'Assets', NULL, 1, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Connection'),
	('CJ-42I', 'Joint Pin - Inner', 'Assets', NULL, 1, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Connection'),
	('CJ-48IF', 'Joint Pin - Inner Fitting', 'Assets', NULL, 1, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Connection'),
	('CJ-48OF', 'Joint Pin - Outer Fitting', 'Assets', NULL, 1, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Connection'),
	('CMP-CLMP', 'หัวแคลมป์', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('CMP-SP-FM', 'เฟรมเวที', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('CMP-TRI.FD', 'หัวเหล็กพับ 3 เหลี่ยมเจาะรูกลม', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('CMP-W.FDPN', 'หัวเหล็กพับ+ลิ่มล็อค', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('CMP-W.H', 'หัวเหล็กหล่อ+ลิ่มล็อค', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('CMP2-42232', 'ท่อกลมปั๊มหัวสำหรีบทำตัว Bracing ตาย', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('CPT-S', 'แผ่นพรมรอง JB', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Equipment'),
	('DF-0617', 'Frame กว้าง 610x1700', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'DF'),
	('DF-0912', 'Frame กว้าง 914x1219', 'Assets', NULL, 5, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'DF'),
	('DF-1004.GS', 'Frame กว้าง 1070x400', 'Assets', NULL, 13, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'DF'),
	('DF-1016.GS', 'Frame กว้าง 1070x1600', 'Assets', NULL, 9, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'DF'),
	('DF-1204', 'Frame กว้าง 1219x490', 'Assets', NULL, 11, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'DF'),
	('DF-1209', 'Frame กว้าง 1219x915', 'Assets', NULL, 11, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'DF'),
	('DF-1212', 'Frame กว้าง 1219x1219', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'DF'),
	('DF-1217', 'Frame กว้าง 1219x1700', 'Assets', NULL, 8, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'DF'),
	('F-1503-B', 'ผ้าเนื้อ สีดำ 1.5x03', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('F-1504-B', 'ผ้าเนื้อ สีดำ 1.5x04', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('F-1505-B', 'ผ้าเนื้อ สีดำ 1.5x05', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('F-1515-B', 'ผ้าเนื้อ สีดำ 1.5x15', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('FM-0618', 'Frame Ø1-1/4" 0.3@2 Step', 'Assets', NULL, 17, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Frame'),
	('FM-1224', 'Frame Ø1-1/4" 0.4@3 Step', 'Assets', NULL, 29, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Frame'),
	('GR-0514', 'รั้วตรง ขนาด 0.53x1.48 ม.', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Guard Rail'),
	('GR-0713', 'รั้วตรง ขนาด 0.53x1.48 ม.', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Guard Rail'),
	('GR-110806', 'รั้วทแยง ขนาด 1.1x0.8 ม.', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Guard Rail'),
	('GR-1114', 'รั้วตรง ขนาด 1.17x1.48 ม.', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Guard Rail'),
	('GR-111616', 'รั้วทแยง ขนาด 1.1x1.6 ม.', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Guard Rail'),
	('GR-1814', 'รั้วตรง ขนาด 1.83x1.48 ม.', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Guard Rail'),
	('GR-B121', 'ราวกันตกนั่งร้านญี่ปุ่น 1219', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Guard Rail'),
	('GR-B182', 'ราวกันตกนั่งร้านญี่ปุ่น 1829', 'Assets', NULL, 13, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Guard Rail'),
	('GR-C091', 'เสากันตกนั่งร้านญี่ปุ่น', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Guard Rail'),
	('H-1717-6', 'H 175x175x7.5x11x6', 'Assets', NULL, 241, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('H-2020-6', 'H 200x200x8x12x6', 'Assets', NULL, 299, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('HB-1118', 'สำหรับระยะนั้งร้าน 1.17x1.83 m', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Bracing'),
	('HB-1124', 'สำหรับระยะนั้งร้าน 1.17x2.44 m', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Bracing'),
	('HB-1224', 'สำหรับระยะนั้งร้าน 1.22x2.44 m', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Bracing'),
	('HB-1818', 'สำหรับระยะนั้งร้าน 1.83x1.83 m', 'Assets', NULL, 9, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Bracing'),
	('HB-1824', 'สำหรับระยะนั้งร้าน 1.83x2.44 m', 'Assets', NULL, 9, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Bracing'),
	('HF-0518', 'Frame ฝาครอบ กว้าง 490x1829', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'DF'),
	('HF-1018', 'Frame ฝาครอบ กว้าง 1050x1829', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'DF'),
	('I-1515-6', 'I 150x75x5.5x9.5x6', 'Assets', NULL, 103, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('I-2020-2', 'I 200x100x7x10x2', 'Assets', NULL, 52, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('I-2020-3', 'I 200x100x7x10x3', 'Assets', NULL, 78, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('I-2020-4', 'I 200x100x7x10x4', 'Assets', NULL, 104, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('I-2020-5', 'I 200x100x7x10x5', 'Assets', NULL, 130, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('I-2020-6', 'I 200x100x7x10x6', 'Assets', NULL, 156, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('I-2525-6', 'I 250x125x7.5x12.5x6', 'Assets', NULL, 230, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('IN-01', 'น็อตร้อยเสากันตกตัวสั้น', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Equipment'),
	('IN-02', 'น็อตร้อยเสากันตกตัวยาว', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Equipment'),
	('JB-02', 'แจ็คเบสยาว 0.2 m', 'Assets', NULL, 2, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Support'),
	('JB-04', 'แจ็คเบสยาว 0.4 m', 'Assets', NULL, 4, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Support'),
	('JB-06', 'แจ็คเบสยาว 0.6 m', 'Assets', NULL, 5, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Support'),
	('LF-01.CMP', 'Stair Clamp', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-0502', 'Ladder Frame 2 Step', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-0504', 'Bracket S Size', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-0601.CM', 'Short L-arm Clamp', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-0704.FD', 'Ladder-arm 1 Step Folding Plate', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-0705.CM', 'Bracket L Size', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-0903', 'Bracket M Size', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-1004', 'Ladder Frame 0.45@2 Step', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-11.FDP', 'Floor-arm Folding Plate', 'Assets', NULL, 1, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-1101.CM', 'Long L-arm Clamp', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-4512', 'Scaffold Ledder Short Standard', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-4517', 'Scaffold Ledder Standard', 'Assets', NULL, 23, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-5017', 'Scaffold Ledder Standard', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LF-5848.CM', 'Small Ledder Panel', 'Assets', NULL, 9, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Ladder&Floor'),
	('LL-50502.3', 'LL 150x50x20x2.3x6', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('LL-50503.2', 'LL 150x50x20x3.2x6', 'Assets', NULL, 41, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-21186', 'O 1/2" x6 ม.', 'Assets', NULL, 6, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-27156', 'O 3/4" x6 ม.', 'Assets', NULL, 8, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-34.9156', 'O 1-3/8" x6 ม.', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-34206', 'O 1" x6 ม.', 'Assets', NULL, 11, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-422304', 'O 1-1/4" x0.4 แบบมี Pinlock', 'Assets', NULL, 1, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-482068', 'O 1-1/2" x6.85 ม.', 'Assets', NULL, 18, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-48231', 'O 1-1/2" x1 ม.', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-48232', 'O 1-1/2" x2 ม.', 'Assets', NULL, 5, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-48232.5', 'O 1-1/2" x2.5 ม.', 'Assets', NULL, 7, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-48233', 'O 1-1/2" x3 ม.', 'Assets', NULL, 8, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-482336', 'O 1-1/4" x3.66 ม.', 'Assets', NULL, 8, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-48234', 'O 1-1/2" x4 ม.', 'Assets', NULL, 11, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-48235', 'O 1-1/2" x5 ม.', 'Assets', NULL, 13, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-482354', 'O 1-1/4" x5.49 ม.', 'Assets', NULL, 13, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('O-48236', 'O 1-1/2" x6 ม.', 'Assets', NULL, 16, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('PLY-012012', 'ไม้อัด 0.12,0.12x0.004 ม.', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('PLY-121220', 'ไม้อัด 1.22x1.22x0.02 ม.', 'Assets', NULL, 14, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('PLY-121820', 'ไม้อัด 1.22x1.83x0.02 ม.', 'Assets', NULL, 20, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('PLY-122420', 'ไม้อัด 1.22x2.44x0.02 ม.', 'Assets', NULL, 27, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('PLY-S', 'แผ่นไม้อัดรอง JB', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Equipment'),
	('PP-2035', 'เสา Prop ค้ำยัน OD นอก 60.8 ใน 48.6', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Support'),
	('PT-428PNCH', 'แผ่นจาน Ringlock', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('PT-488PNCH', 'แผ่นจาน Ringlock', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('PT-FD', 'หัว Bracing', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('PT-HCAST', 'หัวเหล็กหล่อ', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('PT-PINL', 'Pinlock', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('PT-WCAST', 'ลิ่มล็อค', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('RF-1', 'หัวเสียบเสาขึงผ้าใบ', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Roof Part'),
	('RF-1-2', 'คาน Ø1-1/4" ยาว 1.83 มีหัวเสียบเสา 1 ข้าง', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Roof Part'),
	('RF-2', 'คาน Ø1-1/4" ยาว 1.83 มีหัวเสียบเสา 2 ข้าง', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Roof Part'),
	('RF-VNL', 'แผ่นผืนผ้าใบ 1.83x2.44', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Roof Part'),
	('RS-1123', 'แผ่นผ้ายาง 1x1.23', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('RS-1173', 'แผ่นผ้ายาง 1x1.73', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('RS-118', 'แผ่นผ้ายาง 1x18', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('RS-1212', 'แผ่นผ้ายาง 1x2.12', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('RS-1350', 'แผ่นผ้ายาง 1x3.5', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('RS-1390', 'แผ่นผ้ายาง 1x.39', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('RS-1549', 'แผ่นผ้ายาง 1x5.49', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('RT-1010266', 'Rectangle 2"x4" (100x50x2.6)', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('SP-1212-LK', 'Linker 1 ขา สูง 1.2', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SP-1218', 'พื้นเวที 1.22x1.83', 'Assets', NULL, 35, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SP-1712-LK', 'Linker 1 ขา สูง 1.7', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SP-512-LK', 'Linker 1 ขา สูง 0.49', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SP-912-LK', 'Linker 1 ขา สูง 0.9', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SP-CLW', 'แป้นรับแผ่นเวที', 'Assets', NULL, 2, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SP-RG', 'เสาข้องอกันตกเวที', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SP-SS12', 'ขอบใส่ข้างเวที 1.22', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SP-SS18', 'ขอบใส่ข้างเวที 1.83', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SP12-FP', 'Linker', 'Assets', NULL, 5, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SP12-HK', 'Locker', 'Assets', NULL, 4, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Stage Part'),
	('SPS-', 'Span Set', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Equipment'),
	('SQ-1010186', 'Square 4"x4" (100x100x1.8)', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('SQ-1010236', 'Square 4"x4" (100x100x2.3)', 'Assets', NULL, 42, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('SQ-1010286', 'Square 4"x4" (100x100x2.8)', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('ST-03031', 'Truss 0.3x0.3x1 ม.', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('ST-BGR', 'เก้าอี้อัฒจันทร์สีเขียวน้ำทะเล', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('ST-BL', 'เก้าอี้อัฒจันทร์สีน้ำเงิน', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('ST-LGR', 'เก้าอี้อัฒจันทร์สีเขียวใบตองอ่อน', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('TB-EE', 'เกลียวเร่ง ห่วง-ห่วง Turnbuckle Eye-Eye', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Equipment'),
	('TB-HE', 'เกลียวเร่ง ตะขอ-ห่วง Turnbuckle Hook-Eye', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Equipment'),
	('TB-HH', 'เกลียวเร่ง ตะขอ-ตะขอ Turnbuckle Hook-Hook', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Equipment'),
	('TNK-1000', 'Water Cube Tank', 'Assets', NULL, 62, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Others'),
	('U-001', 'Bolt รัด I-Beam', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Equipment'),
	('UJ-04', 'U Head  0.4 m', 'Assets', NULL, 4, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Support'),
	('UJ-06', 'U Head  0.6 m', 'Assets', NULL, 5, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Support'),
	('VB-1818', 'Bracing ระยะ1.83x1.8', 'Assets', NULL, 7, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Bracing'),
	('VB-1818-X-', 'คานกากบาทจับฉาก หัวแคลมป์', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Bracing'),
	('VB-2418', 'Bracing ระยะ2.44x1.8', 'Assets', NULL, 8, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Bracing'),
	('VB-3019', 'Bracing สั้น แบบชักได้ 308.5-194 cm', 'Assets', NULL, 7, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Bracing'),
	('VB-3422', 'Bracing ยาว แบบชักได้ 345-227.8 cm', 'Assets', NULL, 8, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Bracing'),
	('VC-4203', 'เสา Ø1-1/4" 0.3 m', 'Assets', NULL, 1, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4204', 'เสา Ø1-1/4" 0.4 m', 'Assets', NULL, 1, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4206', 'เสา Ø1-1/4" 0.6 m', 'Assets', NULL, 2, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4208', 'เสา Ø1-1/4" 0.8 m', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4209', 'เสา Ø1-1/4" 0.9 m', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4212', 'เสา Ø1-1/4" 1.2 m', 'Assets', NULL, 4, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4224', 'เสา Ø1-1/4" 2.4 m', 'Assets', NULL, 10, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4803', 'เสา Ø1-1/2" 0.3 m', 'Assets', NULL, 2, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4806', 'เสา Ø1-1/2" 0.6 m', 'Assets', NULL, 3, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4809', 'เสา Ø1-1/2" 0.9 m', 'Assets', NULL, 4, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4812', 'เสา Ø1-1/2" 1.2 m', 'Assets', NULL, 6, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4815', 'เสา Ø1-1/2" 1.5 m', 'Assets', NULL, 4, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4818.3', 'เสา Ø1-1/2" 1.8 m', 'Assets', NULL, 7, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4818.6', 'เสา Ø1-1/2" 1.8 m', 'Assets', NULL, 8, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4830.10', 'เสา Ø1-1/2" 3 m', 'Assets', NULL, 13, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('VC-4830.5', 'เสา Ø1-1/2" 3 m', 'Assets', NULL, 13, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'col'),
	('WF-1515-6', 'WF 150x75x5x7x6', 'Assets', NULL, 84, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('WF-2020-6', 'WF 200x100x5.5x8x6', 'Assets', NULL, 128, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Material'),
	('WH-06.B', 'ล้อ 6" แบบมีเบรค', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Support'),
	('WH-08.B', 'ล้อ 8" แบบมีเบรค', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Support'),
	('WH-08.U', 'ล้อ 8" ยูรีเธน', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Support'),
	('WP-2120', 'แผ่นปู 2x.21 m แผ่นไม้กระดาน', 'Assets', NULL, 7, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Panel'),
	('WP-2130', 'แผ่นปู 3x.21 m แผ่นไม้กระดาน', 'Assets', NULL, 11, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Panel'),
	('WP-2418.W', 'แผ่นปู 1.83x0.24 m มีปีกหัวท้าย', 'Assets', NULL, 12, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Panel'),
	('WP-4518.W', 'แผ่นปู 1.17x0.45 m มีปีกหัวท้าย', 'Assets', NULL, 17, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Panel'),
	('WP-5011.W', 'แผ่นปู 1.17x0.5 m มีปีกหัวท้าย', 'Assets', NULL, 11, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Panel'),
	('WP-5018', 'แผ่นปู 1.83x0.5 m ปกติ', 'Assets', NULL, 20, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Panel'),
	('WP-5018.W', 'แผ่นปู 1.83x0.5 m มีปีกหัวท้าย', 'Assets', NULL, 23, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Panel'),
	('WR-0', 'สลิง Wire Rope', 'Assets', NULL, 0, NULL, 0, 0, 0, 0, '', 0, 0, NULL, 'Equipment'),
...
-- Dumping data for table cm.province: ~77 rows (approximately)
